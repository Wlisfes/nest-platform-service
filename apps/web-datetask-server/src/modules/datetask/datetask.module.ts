...
@Module({
    ...
    providers: [DatetaskUtilsService, DatetaskService, DatetaskSystemService, DatetaskSystemProcessor],
    exports: [DatetaskUtilsService, DatetaskService, DatetaskSystemService, DatetaskSystemProcessor]
})
