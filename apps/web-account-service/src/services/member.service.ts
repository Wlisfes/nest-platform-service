...
export class MemberService extends LoggerService {
    ...
    public async httpAuthGraphCodex(headers: OmixHeaders, response: Response) {
        ...
        const key = await fetchKeyCompose(keys.ACCOUNT_MEMBER_LOGIN_CODEX, sid)
    ...
    /**创建员工账号**/
    @Logger
    public async httpCreateMember(headers: OmixHeaders, request: OmixRequest, body: env.BodyCreateMember) {
    ...
    /**编辑员工账号状态**/
    @Logger
    public async httpUpdateStatusMember(headers: OmixHeaders, request: OmixRequest, body: env.BodyUpdateStatusMember) {
        const ctx = await this.databaseService.fetchConnectTransaction()
        try {
            const node = await this.databaseService.fetchConnectEmptyError(headers, this.databaseService.tbMember, {
                message: 'UID不存在',
    ...
    /**员工账号列表**/
    @Logger
    public async httpColumnMember(headers: OmixHeaders, request: OmixRequest, body: env.BodyColumnMember) {
        // return await this.databaseService.fetchConnectBuilder(headers, this.databaseService.tbMember, async qb => {
